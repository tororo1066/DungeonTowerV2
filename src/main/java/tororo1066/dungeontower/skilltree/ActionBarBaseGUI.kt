...
class ActionBarBaseGUI(val p: Player): Listener {
    ...
    fun show(){
        ...
        runnable = object : BukkitRunnable() {
            ...
            override fun run() {
                ...
                if (xLocation in 15..17 && yLocation in 7..8){
                ...
                p.showTitle(
                    Title.title(Component.text(builder.toString()).font(Key.key("custom_ui_save"))
